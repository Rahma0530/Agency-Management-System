...
export const AGENCY_ROLES: Record<UserRole, RoleMetadata> = {
  ...
  am_agent: {
    ...
    badgeText: 'var(--lilac)',
    defaultModule: 'onboarding',
    allowedModules: ['onboarding', 'service_briefs', 'tasks', 'campaigns', 'reports'],
    canRegisterClients: false,
    canCreateCampaign: false,
    canManageCapacity: false,
    canAssignAM: false,
  ...
  media_buying_agent: {
    ...
    badgeText: '#7dd3fc',
    defaultModule: 'campaigns',
    allowedModules: ['campaigns', 'onboarding', 'service_briefs', 'daily_operations', 'tasks', 'reports'],
    canRegisterClients: false,
    canCreateCampaign: true,
    canManageCapacity: false,
    canAssignAM: false,
  ...
  seo_agent: {
    ...
    allowedModules: ['daily_operations', 'onboarding', 'service_briefs', 'tasks', 'reports'],
    canRegisterClients: false,
    canCreateCampaign: false,
    canManageCapacity: false,
    canAssignAM: false,
