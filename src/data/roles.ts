...
export const AGENCY_ROLES: Record<UserRole, RoleMetadata> = {
  ...
  am_team_lead: {
    ...
    defaultModule: 'onboarding',
    allowedModules: ['onboarding', 'service_briefs', 'capacity', 'tasks', 'campaigns'],
    canRegisterClients: false,
    canCreateCampaign: false,
    canManageCapacity: true,
    canAssignAM: true,
  ...
  am_agent: {
    ...
    badgeText: 'var(--lilac)',
    defaultModule: 'onboarding',
    allowedModules: ['onboarding', 'service_briefs', 'tasks', 'campaigns'],
    canRegisterClients: false,
    canCreateCampaign: false,
    canManageCapacity: false,
    canAssignAM: false,
  ...
  media_buying_team_lead: {
    ...
    allowedModules: ['campaigns', 'onboarding', 'service_briefs', 'daily_operations', 'tasks', 'capacity'],
    canRegisterClients: false,
  ...
  media_buying_agent: {
    ...
    badgeText: '#7dd3fc',
    defaultModule: 'campaigns',
    allowedModules: ['campaigns', 'onboarding', 'service_briefs', 'daily_operations', 'tasks'],
    canRegisterClients: false,
    canCreateCampaign: true,
    canManageCapacity: false,
    canAssignAM: false,
  ...
  seo_team_lead: {
    ...
    badgeText: '#34d399',
    defaultModule: 'onboarding',
    allowedModules: ['onboarding', 'service_briefs', 'daily_operations', 'tasks', 'capacity'],
    canRegisterClients: false,
    canCreateCampaign: false,
    canManageCapacity: true,
    canAssignAM: false,
  ...
  seo_agent: {
    ...
    allowedModules: ['daily_operations', 'onboarding', 'service_briefs', 'tasks'],
    canRegisterClients: false,
    canCreateCampaign: false,
    canManageCapacity: false,
    canAssignAM: false,
