...
export const AGENCY_ROLES: Record<UserRole, RoleMetadata> = {
  ...
  am_team_lead: {
    ...
    defaultModule: 'dashboard',
    allowedModules: ['dashboard', 'my_work', 'onboarding', 'service_briefs', 'capacity', 'tasks', 'campaigns', 'reports'],
    canRegisterClients: false,
    canCreateCampaign: false,
    canManageCapacity: true,
    canAssignAM: true,
  ...
  media_buying_team_lead: {
    ...
    badgeText: '#38bdf8',
    defaultModule: 'dashboard',
    allowedModules: ['dashboard', 'my_work', 'campaigns', 'onboarding', 'service_briefs', 'daily_operations', 'tasks', 'capacity', 'reports'],
    canRegisterClients: false,
  ...
  seo_team_lead: {
    ...
    badgeText: '#34d399',
    defaultModule: 'dashboard',
    allowedModules: ['dashboard', 'my_work', 'onboarding', 'service_briefs', 'daily_operations', 'tasks', 'capacity', 'reports'],
    canRegisterClients: false,
    canCreateCampaign: false,
    canManageCapacity: true,
    canAssignAM: false,
